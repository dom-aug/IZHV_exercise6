        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    //var currency = GUILayout.TextField(InventoryManager.Instance.availableCurrency.ToString());
                    //var result = Int32.Parse(currency);

                    if (GUI.changed)
                    {
                        InventoryManager.Instance.availableCurrency = currency;
                        //InventoryManager.Instance.availableCurrency = result;
                    }
                }
                GUILayout.EndHorizontal();
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    interactiveMode = GUILayout.Toggle(interactiveMode, "on/off", GUILayout.ExpandWidth(true));
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    masterMuted = GUILayout.Toggle(masterMuted, "on/off", GUILayout.ExpandWidth(true));
